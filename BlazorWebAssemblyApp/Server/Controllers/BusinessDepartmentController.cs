...
namespace BlazorWebAssemblyApp.Server.Controllers
{
    ...
    {
        private readonly IBusinessDepartmentRepository departmentRepository;

        public BusinessDepartmentController(IBusinessDepartmentRepository departmentRepository)
        {
        ...
        [HttpGet("{id:int}")]
        public async Task<ActionResult<BusinessDepartment>> GetDepartment(int id)
        {
            try
            {
